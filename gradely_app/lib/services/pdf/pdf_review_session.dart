...
class PdfReviewSession {
  static Future<File> generate(
      Classroom classroom, List<StudentGrade> listStudent) async {
    final pdf = Document();
    ...
    pdf.addPage(
      MultiPage(
        build: (context) => [
          ...
          buildReviewGradeTable(listStudent),
        ],
        footer: (context) => buildFooter(),
      ),
    );
    String pdfName = 'review_session' + classroom.className + ' ' + classroom.teacherName;
  ...
  static Widget buildDetailClass(Classroom classroom) => Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Text('Report Review Session', style: TextStyle(fontWeight: FontWeight.bold)),
  ...
  static Widget buildReviewGradeTable(List<StudentGrade> listStudent) {
    final headers = [
      'Student ID',
      'Email',
      'Name',
