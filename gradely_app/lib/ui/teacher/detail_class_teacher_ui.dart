        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              // Text(widget.classroom.subjectName),
              // Text(widget.classroom.className),
              // Text(widget.classroom.teacherName),
              // Text(widget.classroom.day),
              // Text(Utility.convertDateTimeToString(widget.classroom.classBegin)),
              // Text(Utility.convertDateTimeToString(widget.classroom.classEnd)),
